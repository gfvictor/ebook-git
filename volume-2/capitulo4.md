...
### 4.1 O que é, Afinal, um Conflito?
...
### 4.2 A Anatomia do Caos: Entendendo Marcadores
...
### 4.3 Os Dois Caminhos da Resolução 
...
### 4.3.1 Caminho A: Conflito no `merge` (ou `git pull` padrão)
...
### 4.3.2 Caminho B: Conflito no `rebase`
