...
### 4.1 Além do Básico: O Mecanismo do Three-Way Merge
...
### 4.2 O Dilema do Fast-Forward vs. No-Fast-Foward (`--no-ff`)
...
### 4.2.1 Por que o Fast-Forward pode ser um erro?
...
### 4.2.2 A Flag `--no-ff` e o "Padrão GitHub"
...
### 4.3 Squash Merging: A Arte da Limpeza
...
### 4.4 Estratégias de Merge: Do Legado à Próxima Geração
...
### 4.4.1 A Estratégia `recursive` (O Velho Guerreiro) 
...
### 4.4.2 O Reinado de `ORT` (O Gêmeo Ostensivo)
...
### 4.5 Merge vs. Rebase: A Batalha Ideológica
