...
- **Volume I: Iniciante - Do Caos ao Primeiro Commit.** 
Focado em fundamentos locais (`add`, `commit`, `restore`, `reset`), filosofia de snapshots, e a configuração de um ambiente de trabalho saudável (SSH e `git config`);
...
- [LaTeX - Alinhamento de Textohttps](https://www.overleaf.com/learn/latex/Text_alignment)
- [LaTeX - Uso de Cores](https://www.overleaf.com/learn/latex/Using_colors_in_LaTeX)
...
> Em caso de erros de compilação em decorrência de erro no script `build.lua`, por favor abra um *Issue* e comunique o problema. Obrigado.
